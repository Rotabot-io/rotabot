...
type SlackClient interface {
	AddBookmark(string, slack.AddBookmarkParameters) (slack.Bookmark, error)
	AddBookmarkContext(context.Context, string, slack.AddBookmarkParameters) (slack.Bookmark, error)
	AddChannelReminder(string, string, string) (*slack.Reminder, error)
	AddChannelReminderContext(context.Context, string, string, string) (*slack.Reminder, error)
	...
	AddRemoteFile(slack.RemoteFileParameters) (*slack.RemoteFile, error)
	AddRemoteFileContext(context.Context, slack.RemoteFileParameters) (*slack.RemoteFile, error)
	...
	AddUserReminderContext(context.Context, string, string, string) (*slack.Reminder, error)
	...
	DeleteReminderContext(context.Context, string) error
	...
	EditBookmark(string, string, slack.EditBookmarkParameters) (slack.Bookmark, error)
	EditBookmarkContext(context.Context, string, string, slack.EditBookmarkParameters) (slack.Bookmark, error)
	...
	GetOtherTeamInfo(string) (*slack.TeamInfo, error)
	...
	GetTeamProfile() (*slack.TeamProfile, error)
	...
	RemoveBookmark(string, string) error
	RemoveBookmarkContext(context.Context, string, string) error
	...
	RemoveRemoteFile(string, string) error
	RemoveRemoteFileContext(context.Context, string, string) error
	...
	SetUserCustomFields(string, map[string]slack.UserProfileCustomField) error
	SetUserCustomFieldsContext(context.Context, string, map[string]slack.UserProfileCustomField) error
	...
	ShareRemoteFile([]string, string, string) (*slack.RemoteFile, error)
	ShareRemoteFileContext(context.Context, []string, string, string) (*slack.RemoteFile, error)
	...
	UpdateRemoteFileContext(context.Context, string, slack.RemoteFileParameters) (*slack.RemoteFile, error)
	UpdateUserGroup(string, ...slack.UpdateUserGroupsOption) (slack.UserGroup, error)
